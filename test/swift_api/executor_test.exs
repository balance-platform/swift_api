defmodule SwiftApi.ExecutorTest do
  use ExUnit.Case
  doctest SwiftApi.Executor
  import Mock
  alias SwiftApi.Executor
                ...
                },
                {
                    "endpoints": [
                        ...
                        },
                        {
                            ...
                            "region": "dc-cr",
                            "region_id": "dc-cr",
                            "url": "https://object.someurl.pro/v1/AUTH_b31fb563c0b644c8a6a6c1da43258e88"
                        },
                        {
  ...
  test "должен успешно авторизоваться" do
    with_mock SwiftApi.HttpClient,
      ...
      "https://object.someurl.pro/v1/AUTH_b31fb563c0b644c8a6a6c1da43258e88" =
  ...
  test "при tries от 3 и выше должен сразу выходить не делая запрос" do
    assert Executor.identify(%SwiftApi.Client{}, 3) == {:error, "Can't authorize"}
  end
end
